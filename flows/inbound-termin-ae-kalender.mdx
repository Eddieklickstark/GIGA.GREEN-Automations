...
description: Bucht ein Inbound-Lead einen Infotermin, setzt dieser Flow den zuständigen Account Executive als Meeting-Host in Zoho, lädt ihn im Google Calendar ein und trägt den Termin in die SQL-Liste ein.
---
...
Bucht ein **Inbound-Lead** einen Infotermin, hängt dieser Flow den zuständigen **Account Executive** richtig an den Termin: Er setzt ihn in **Zoho** als **Meeting-Host** und lädt ihn im **Google Calendar** ein. Den Termin trägt er außerdem in die **SQL-Liste** (Google Sheet) ein.
