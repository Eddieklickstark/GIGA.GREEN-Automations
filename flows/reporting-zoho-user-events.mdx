...
description: Holt wöchentlich die AE-/User-Liste und die Event-Auswahlwerte aus Zoho CRM und schreibt sie in ein Google Sheet, als Datenbasis u. a. für die Owner-Zuordnung.
---
...
Damit nachgelagerte Flows (z. B. die Owner-Zuordnung von Leads) mit aktuellen Stammdaten arbeiten, holt dieser Flow **wöchentlich die Zoho-User-Liste (AEs)** und die **Auswahlwerte des Event-Feldes** und schreibt beides in ein Google Sheet. Vorher leert er die alten Werte, damit das Sheet immer den aktuellen Stand zeigt.
