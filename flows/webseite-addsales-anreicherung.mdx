...
description: Verarbeitet Anfragen aus dem Addsales-Formular, legt passende Zoho-Leads an oder aktualisiert bestehende, reichert sie an und korrigiert falsch genutzte Calendly-Links.
---
...
Anfragen aus dem **Addsales-Formular** werden automatisch in Zoho CRM überführt: Der Flow legt entweder einen **neuen Lead an oder aktualisiert einen bestehenden**, reichert die Daten an und **korrigiert dabei falsch genutzte Calendly-Links** über einen Abgleich in Google Sheets.
...
| **Verknüpfte Tools** | Zoho CRM, Google Sheets, HTTP |
