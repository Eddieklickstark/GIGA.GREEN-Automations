...
description: Nimmt tägliche Klickdaten per Webhook entgegen, bereitet sie auf und schreibt sie als Zeile ins Reporting-Sheet.
---
...
Nimmt **tägliche Klickdaten per Webhook** entgegen und schreibt sie als neue Zeile ins **Reporting-Sheet**. Ein schlanker Flow, der die Klickwerte fürs Dashboard sammelt.
