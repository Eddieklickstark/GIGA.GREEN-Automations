...
<Callout kind="info">
  **Bereich:** Reporting und Dashboard · **Status:** Aktiv · **Make-ID:** 2082018
</Callout>
...
- **Auslöser:** Webhook mit den eingehenden Klickdaten
...
<Steps>
  ...
  <Step title="Ins Sheet schreiben">
    Die Klickdaten werden als **neue Zeile in das Google Sheet** geschrieben.
  </Step>
</Steps>
