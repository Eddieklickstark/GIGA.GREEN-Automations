...
description: Liest täglich das Supermetrics-Ad-Spend-Sheet und schreibt die Werte in ein Archiv-Sheet, damit die Werbeausgaben dauerhaft erhalten bleiben.
---
...
Das Supermetrics-Sheet zeigt immer nur die **aktuellen Ad-Spend-Werte** und wird laufend überschrieben. Dieser kleine Flow liest die Werte aus und hängt sie an ein **Archiv-Sheet** an. So bleibt der tägliche Verlauf der Werbeausgaben erhalten, als Datenbasis für Reporting und Dashboards.
