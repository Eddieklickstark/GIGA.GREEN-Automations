...
description: Landet ein Event-Formular in Zoho, setzt dieser Flow den richtigen Lead-Owner, hält die Conversion per Notiz und Slack-Meldung fest und pflegt die Looker-Kosten-Liste.
---
...
Landet über das **Event-Formular** ein Datensatz in Zoho, ordnet dieser Flow den Lead dem **richtigen Owner** zu, hält die Conversion fest (Notiz im Spreadsheet, **Slack**-Meldung im Conversion-Chat, Benachrichtigungs-E-Mail) und ergänzt das Event bei Bedarf in der **Looker-Kosten-Liste**. Direkt nach dem Eingang ist der Lead oft noch nicht in Zoho, deshalb sucht ihn der Flow in mehreren Anläufen.
