...
<Callout kind="info">
  **Bereich:** Reporting und Dashboard · **Status:** Aktiv · **Make-ID:** 4317229
</Callout>
...
Überwacht **neue Leads im Sheet für Looker Studio**, prüft sie gegen den **Bestand auf Dubletten** und filtert **Testleads** heraus. Nur neue, noch nicht vorhandene Leads landen in der bereinigten Liste, auf der das Reporting in Looker Studio aufsetzt.
...
- **Auslöser:** Neue Zeilen im Lead-Sheet (Google Sheets, watchRows)
...
<Steps>
  ...
  <Step title="Dublette prüfen und Testlead filtern">
...
| Dubletten landen doch in der Liste | Dublettenprüfung greift nicht, etwa wegen abweichender Schreibweise | Filter-Schritt „Überprüfen ob neue Leads bereits in der Liste sind" kontrollieren |
