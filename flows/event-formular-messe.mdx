...
description: Kommt ein Lead über das Messe-Formular (Replit) rein, legt dieser Flow Kontakt, Account, Opportunity oder Lead in Zoho an oder aktualisiert sie, plant Follow-up-Aufgaben und meldet das Ergebnis an die WebApp zurück.
---
...
Dieser Flow verbindet das **Messe-Formular (Replit)** mit **Zoho CRM**. Er schaut, ob es zum Messe-Lead schon einen Kontakt, Account, eine Opportunity oder einen Lead gibt, und legt sie an oder aktualisiert sie. Dazu plant er Follow-up-Aufgaben, protokolliert fehlgeschlagene Datensätze und schickt eine Antwort an die WebApp zurück.
