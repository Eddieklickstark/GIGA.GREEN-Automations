...
<Callout kind="info">
  **Bereich:** Termine und Calendly · **Status:** Aktiv · **Make-ID:** 5179280
</Callout>
...
Storniert jemand einen AddSales-Termin in **Calendly**, entfernt dieser Flow den **Fehl-Lead**, der durch die Buchung in Zoho entstanden ist, aber nur wenn der Lead **jünger als ein Tag** ist (also wirklich aus dieser Buchung stammt). Das Team erfährt die Stornierung über **Slack**.
...
- **Auslöser:** Webhook, wenn eine Stornierung per E-Mail eingeht
...
<Steps>
  ...
  <Step title="Verzögern und Lead suchen">
